...
# sbatch --export=CONFIG_DIR=config/04_plot_dotplot/archive/vbct_hpc_or_old_layout/vbct_small hpc/slurm/run_04_xenium_multi_sample_dotplot_from_config.sl
...
python 04_plot_multi_sample_dotplot_from_config_local.py --config "$CONFIG"
