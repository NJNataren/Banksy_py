...
0. `00_xenium_clustering_clean_adata.py`
   Run BANKSY clustering from raw Xenium AnnData and save clean expression AnnData with BANKSY labels/embeddings transferred back onto it.
...
```text
run_01_xenium_clustering.sl
run_01_xenium_clustering_large.sl
run_00_xenium_clustering_clean_adata_ck_skin_res.sl
```
...
```bash
sbatch run_01_xenium_clustering.sl
```
